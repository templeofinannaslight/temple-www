...
function ResourceCard({ label, url, fellowship }: Resource & { fellowship: string }) {
  return (
    <a
      ...
      className="group flex items-center justify-between gap-3 bg-accent/40 backdrop-blur-md border-2 border-accent-dark rounded-xl px-5 py-4 shadow-[0_0_15px_#26619c40] hover:border-accent-light hover:shadow-[0_0_25px_#26619c80] transition-all"
    >
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex justify-center mb-12">
              <div className="inline-flex bg-accent/40 backdrop-blur-md border-2 border-accent-dark rounded-xl p-1">
                <button
                  onClick={() => {
                    setTab("aa");
